...
import ru.relicarium.pledge.integration.AuctionIntegrationException;
...
public class PledgeExceptionHandler {
    ...
    @ExceptionHandler(AuctionIntegrationException.class)
    public ResponseEntity<ApiErrorResponse> handleAuctionIntegration(AuctionIntegrationException exception) {
        return ResponseEntity
                .status(HttpStatus.BAD_GATEWAY)
                .body(new ApiErrorResponse(exception.getMessage()));
    }
